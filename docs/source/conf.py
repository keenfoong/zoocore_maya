# -*- coding: utf-8 -*-
#
# zoocore_maya_maya documentation build configuration file, created by
...
htmlhelp_basename = 'zoocore_mayadoc'
...
latex_documents = [
    (master_doc, 'zoocore_maya.tex', u'zoocore_maya Documentation',
...
man_pages = [
    (master_doc, 'zoocore_maya', u'zoocore_maya Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'zoocore_maya', u'zoocore_maya Documentation',
     author, 'zoocore_maya', 'One line description of project.',
     'Miscellaneous'),
]
...
def skip(app, what, name, obj, skip, options):
    """ Make's sure the __init__ is generated
    """
    if name == "__init__":
        return False
    return skip
